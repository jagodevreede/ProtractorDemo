...
declare module angular {
    ...
    interface IAngularStatic {
        ...
        /**
         * The angular.module is a global place for creating, registering and retrieving Angular modules. All modules (angular framework or 3rd party) that should be available to an application must be registered using this mechanism.
         *
    ...
    interface IAttributes {
        ...
        /**
         * Converts an attribute name (e.g. dash/colon/undersframework-delimited string, optionally prefixed with x- or data-) to its normalized, camelCase form.
         *
    ...
    interface IFilterProvider extends IServiceProvider {
         ...
         * register(name);
         *
         * @param name Name of the filter function, or an object map of filters where the keys are the filter names and the values are the filter factories. Note: Filter names must be valid angular Expressions identifiers, such as uppercase or orderBy. Names with special characters, such as hyphens and dots, are not allowed. If you wish to namespace your filters, then you can use capitalization (myappSubsectionFilterx) or undersframeworks (myapp_subsection_filterx).
         */
